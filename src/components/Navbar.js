                ...
                <div className="bg-gray-800 divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
                  <div className="px-5 pt-3 pb-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="flex justify-start lg:w-0 lg:flex-1">
                          <Link to='/' className="w-auto h-8 text-5xl text-white no-underline font-carattere">Night Sky</Link>
                        </div>
                      </div>
                      <div className="-mr-2">
                    ...
                    <div className="mt-6">
                      <nav className="grid text-white font-sourceSerifPro gap-y-8">Explore space with us</nav>
                    </div>
                  </div>
